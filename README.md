...
# 
# Due to the simple nature of my initial project proposal of searching a file for words/sentences, I added 7 more options to my project to better cover several Linux               Administation tasks and use more linux os commands.
